...
const  AccountRequest = () => {
    ...
    const [paynentConfirm, setPaynentConfirm] = useState(false) 
  ...
  switch (status) {
    ...
    return (
        ...
        return prev+curItem.quantity*curItem.price
                        ...
                        <div className={`w-full flex p-3 flex-col justify-center items-center flex-wrap gap-4 px-10 rounded-2xl ${dark?"bg-background-dark bg-opacity-20 shadow-md shadow-background-dark":"bg-primary/20  bg-opacity-70 shadow-md shadow-gray-300"}`}>
                            ...
                            <div className='flex justify-center items-center gap-4 flex-wrap w-full'>
                                ...
                                <div className={`flex justify-center items-center   py-1  rounded-2xl `}>
                                            <h1 className=' text-sm  '>Order Attchment:</h1>
                                            <input
                                        name="files"
                                        type="file"
                            ...
                            <div className='w-full flex items-center flex-col md:flex-row justify-center gap-4 '>
                                ...
                                <div className='flex justify-center items-center gap-2'>
                                <label htmlFor="Esclate to" className="block   text-sm font-medium "> Esclate To</label>
                                    <select
                                        id="Esclate to"
                                        name="Esclate to"
                                        value={esclate}
                        ...
                        <button onClick={submitHandler} className='w-[150px] p-2 rounded-2xl bg-primary text-white text-md'>Esclate</button>
                            <button onClick={() => {
                                    ...
                                    setStatus("PaynentConfirm")
                                setPaynentConfirm(false)
                                setOpen(true)
                                }}
                                className={`w-[150px] p-2 rounded-2xl text-white ${paynentConfirm?"bg-green-200":"bg-green-500"}`}
