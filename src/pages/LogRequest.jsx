    ...
    return (
       <div className="relative w-full h-screen">
            ...
            <div className="relative  w-full h-full flex items-center justify-center mb-32    ">
                ...
                <div className={`w-full md:w-5/6 md:ml-64 ml-32 h-full mt-32 ${dark ? "text-white" : "text-primary font-semibold"} px-8 `}>
                    <div className='w-full flex justify-between items-center pr-8  mb-4'>
                ...
                <h1 className={`${dark ? "text-white" : "text-primary"} text-lg font-medium`}>Date:</h1>
                <div className='flex items-center justify-center gap-2'>
                  ...
                  <input
                    ...
                    className={` w-[120px] p-1 rounded-2xl focus:outline-none appearance-none text-sm ${dark?"bg-card-dark shadow-md shadow-background-dark text-white":"border border-gray-300 bg-white text-sm font-thin"} `}
                  />
                </div>
                <div className='flex items-center justify-center gap-2'>
                  ...
                  <input
                    ...
                    className={` w-[120px] p-1 rounded-2xl focus:outline-none appearance-none ${dark?"bg-card-dark shadow-md shadow-background-dark text-white":"border border-gray-300 bg-white   text-sm font-thin"} `}
                  />
                </div>
                        </div>
                        <div className='flex items-center justify-center gap-1'>
                <h1 className={`${dark ? "text-white" : "text-primary"} text-lg font-medium`}>Status:</h1>
                <form className='rounded relative' >
                  <MdFilterAlt className='absolute top-2 right-2 text-sm text-gray-500'/>
                  ...
                  <select
                    ...
                    className={` w-[110px] p-1 rounded-2xl focus:outline-none appearance-none ${dark?" text-white bg-card-dark shadow-md shadow-background-dark ":"border border-gray-300 bg-white  text-sm font-thin"} `}
                >
                ...
                <div className={`rounded-2xl overflow-hidden mr-8 p-2 ${dark ? "bg-card-dark shadow-md shadow-background-dark border border-gray-700" : "bg-white shadow-xl shadow-secondairy"}`}>
                        ...
                        {isMobile ? (
                            data.map((row) => (
                                <div
                                     onClick={()=>{navigate(`/track-request/${row.id}`)}}
                                key={row.id}
